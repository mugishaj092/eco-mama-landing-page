...
const Hero = () => {
  return (
    <div className='mx-20 flex justify-between bg-red-200'>
      <div className='w-[50%] flex flex-col  justify-center gap-10'>
        <div className='flex flex-col gap-4'>
          <h1 className='text-3xl font-bold text-primary'><span className='text-4xl'>ECO-MAMA </span>Empowering Women’s Mental Health During Climate Change</h1>
      ...
      <div className='w-[50%]'>
        <Image src={showcase} alt='showcase' width={550} />
      </div>
    </div>
  )
}
